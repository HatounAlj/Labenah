 ...
 */
class SampleController: UIViewController, TurtleViewControllerInterface {
    ...
    /// The web view that runs the turtle code (this is not an outlet because WKWebView isn't    var _webView: WKWebView!
    ...
    lazy var _workbenchViewController: WorkbenchViewController = {
        ...
        workbenchViewController.delegate = self as WorkbenchViewControllerDelegate
    ...
    var _codeGeneratorService: CodeGeneratorService = {
        ...
        let codeGeneratorService = CodeGeneratorService(
            jsCoreDependencies: [
                ...
                "Turtle/blockly_web/msg/js/ar.js"
            ])
    ...
    deinit {
        ...
        if let webView = _webView {
            webView.configuration.userContentController.removeScriptMessageHandler(
                forName:SampleController.JS_CALLBACK_NAME)
            webView.stopLoading()
        }
        resetTurtleCode()
    ...
    override func viewDidLoad() {
        ...
        userContentController.add(ScriptMessageHandler(self as WKScriptMessageHandler),
                                  name: SampleController.JS_CALLBACK_NAME)
        ...
        _webView.navigationDelegate = self as? WKNavigationDelegate
 ...
 */
extension SampleController: WKScriptMessageHandler {
...
extension SampleController: WorkbenchViewControllerDelegate {
...
extension SampleController:  WKNavigationDelegate {
